...
class ChatLM(BaseLM):
    ...
    def __init__(self, model, truncate=False):
        ...
        #self.tokenizer = transformers.GPT2TokenizerFast.from_pretrained("gpt2")   D:\胡刚老师\testCODE\PIXIU\src\gpt2
        self.tokenizer = transformers.GPT2TokenizerFast.from_pretrained("../src/gpt2")
        self.headers = {
