...
<div align="left" style="margin-top: 40px; display: flex; flex-wrap: wrap; gap: 20px;">
  <!-- 左侧图片 -->
  <div style="flex: 1 1 45%; min-width: 300px;">
    <img src="https://github.com/qqgzi/LanMe/blob/master/asset/human.jpg" 
         alt="The LanMe Framework" style="width: 100%; height: auto;">
  </div>
...
<!-- 评估基准图 -->
<div style="display: flex; justify-content: center; align-items: center; width: 100%; height: 400px; margin-top: 40px;">
